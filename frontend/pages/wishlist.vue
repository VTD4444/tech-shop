...
<template>
  <UiContainer class="py-8">
    <UiText as="h1" size="2xl" class="mb-8">My Wishlist</UiText>
    ...
    <UiEmptyState
      ...
      description="Save products you like and come back later."
    >
      <template #action>
        <UiButton to="/products" variant="primary">Browse Products</UiButton>
      </template>
    </UiEmptyState>
